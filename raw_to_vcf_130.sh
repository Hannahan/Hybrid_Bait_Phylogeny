...
output=~/iROD/vcf_for_lyndsey/${acc}.vcf
...
bowtie2 --local  --score-min G,130,8 -x ~/bowtie_index/All_loci -1 f_prd.fq -2 r_prd.fq.gz -U f_uprd.fq.gz,r_uprd.fq.gz -S output.sam 2>$bowtie
